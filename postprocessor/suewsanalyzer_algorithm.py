...
class ProcessingSuewsAnalyzerAlgorithm(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        for grid in grid_list:
            ...
            if dayTypeStr == "0":  # Diurnal
                ...
                data1 = data1[data1.loc[:, "Zenith"] > 90.0]
            var = self.varType[self.id][0].split(" ")[
                0
            ]  # get position and slice variable
    ...
    def rasterize(
        ...
        trgt = gdal.GetDriverByName("GTiff").Create(
            dst, cols, rows, 1, gdal.GDT_Float32
        )
    ...
    def addattributes(self, vlayer, matdata, header):
        ...
        if caps & QgsVectorDataProvider.Capability.AddAttributes:
            ...
            raise QgsProcessingException(
                "Error", "Vector Layer does not support adding attributes"
            )
    ...
    def shortHelpString(self):
        return self.tr(
            "The <b>SUEWS Analyzer</b> plugin can be used to make basic grid analysis of model results generated by the SUEWS model.<br>"
            "\n"
            "--------------\n"
