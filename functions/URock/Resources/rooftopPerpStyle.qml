...
<qgis maxScale="0" labelsEnabled="0" version="3.16.1-Hannover" simplifyDrawingTol="1" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" simplifyMaxScale="1" readOnly="0" minScale="100000000" simplifyDrawingHints="1" simplifyAlgorithm="0">
  ...
  <fieldConfiguration>
    ...
    <field name="LCP" configurationFlags="None">
    ...
    <field name="HCM" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    <alias name="" field="ID_STACKED_BLOCK" index="0"/>
    <alias name="" field="UPWIND_FACADE_ID" index="1"/>
    <alias name="" field="HEIGHT_ROO" index="2"/>
    <alias name="" field="LCP" index="3"/>
    <alias name="" field="HCM" index="4"/>
  </aliases>
  <defaults>
    ...
    <default field="LCP" applyOnUpdate="0" expression=""/>
    <default field="HCM" applyOnUpdate="0" expression=""/>
  </defaults>
  <constraints>
    ...
    <constraint unique_strength="0" notnull_strength="0" field="LCP" exp_strength="0" constraints="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="HCM" exp_strength="0" constraints="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="LCP"/>
    <constraint exp="" desc="" field="HCM"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column type="field" width="-1" name="LCP" hidden="0"/>
      <column type="field" width="-1" name="HCM" hidden="0"/>
