...
<qgis maxScale="0" labelsEnabled="0" version="3.16.1-Hannover" simplifyDrawingTol="1" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" simplifyMaxScale="1" readOnly="0" minScale="100000000" simplifyDrawingHints="1" simplifyAlgorithm="0">
  ...
  <referencedLayers/>
  <fieldConfiguration>
    <field name="id_build" configurationFlags="None">
  ...
  <aliases>
    <alias name="" field="id_build" index="0"/>
    <alias name="" field="height_roo" index="1"/>
  </aliases>
  <defaults>
    <default field="id_build" applyOnUpdate="0" expression=""/>
    <default field="height_roo" applyOnUpdate="0" expression=""/>
  </defaults>
  <constraints>
    <constraint unique_strength="0" notnull_strength="0" field="id_build" exp_strength="0" constraints="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="height_roo" exp_strength="0" constraints="0"/>
  </constraints>
  <constraintExpressions>
    <constraint exp="" desc="" field="id_build"/>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      <column type="field" width="-1" name="id_build" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="id_build"/>
  </editable>
  <labelOnTop>
    <field labelOnTop="0" name="height_roo"/>
    <field labelOnTop="0" name="id_build"/>
  </labelOnTop>
  <dataDefinedFieldProperties/>
  <widgets/>
  <previewExpression>"id_build"</previewExpression>
  <mapTip></mapTip>
