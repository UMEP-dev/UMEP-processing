...
def solver(
    ...
    if DESCENDING_Y:
        e[
            indF.get_level_values(0),
            indF.get_level_values(1),
            indF.get_level_values(2),
        ] = 0.0
        f[
            indE.get_level_values(0),
            indE.get_level_values(1),
            indE.get_level_values(2),
        ] = 0.0
        g[
            indH.get_level_values(0),
            indH.get_level_values(1),
            indH.get_level_values(2),
        ] = 0.0
        h[
            indG.get_level_values(0),
            indG.get_level_values(1),
            indG.get_level_values(2),
        ] = 0.0
        m[
            indM.get_level_values(0),
            indM.get_level_values(1),
            indM.get_level_values(2),
        ] = 0.0
        n[
            indN.get_level_values(0),
            indN.get_level_values(1),
            indN.get_level_values(2),
        ] = 0.0
    else:
        e[
            indE.get_level_values(0),
    ...
    o[
        indO.get_level_values(0),
        indO.get_level_values(1),
        indO.get_level_values(2),
    ] = 0.5
    p[
        indP.get_level_values(0),
        indP.get_level_values(1),
        indP.get_level_values(2),
    ] = 0.5
    q[
        indQ.get_level_values(0),
        indQ.get_level_values(1),
        indQ.get_level_values(2),
    ] = 0.5
