...
def vegunitsgeneration(
    ...
    if (
        ...
        if (treetrunkunder.ndim > 1) and (trees.ndim > 1):
            ...
            vegdemtemp[
                int(rowmin) : int(rowmin + trees.shape[0]),
                int(colmin) : int(colmin + trees.shape[1]),
            ] = trees
            vegdem2temp[
                int(rowmin) : int(rowmin + trees.shape[0]),
                int(colmin) : int(colmin + trees.shape[1]),
        ...
        vegdemtemp[
            int(rowmin) : int(rowmin + rowmax),
            int(colmin) : int(colmin + colmax),
        ] = trees
        vegdem2temp[
            int(rowmin) : int(rowmin + rowmax),
            int(colmin) : int(colmin + colmax),
