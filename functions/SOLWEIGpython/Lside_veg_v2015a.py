...
def Lside_veg_v2015a(
    ...
    # This m-file is the current one that estimates L from the four cardinal
    # points 20100414
    ...
    if altitude > 0:  # daytime
        ...
        # betasun = np.arctan(0.5*np.tan(svfalfaE)*(1+F_sh)) #TODO This should
    ...
    # clear alfaB betaB betasun Lsky Lwallsh Lwallsun Lveg Lground Lrefl
    # viktveg viktwall viktsky
