...
from ...functions.SOLWEIGpython import Solweig_2026a_calc_forprocessing_final as so
...
from ...functions.SOLWEIGpython.ground_surface_final import initiate_groundScheme
import numpy as np
import json
import zipfile
import pandas as pd
...
def solweig_run(configPath, feedback):
    ...
    if groundScheme == 1:
        ...
        if configDict['input_surf'] != '':
            ...
            _, _, Rn, Rn_past, G, cap_grid, diff_grid, \
                    a1_grid, a2_grid, a3_grid = initiate_groundScheme(lcgrid.copy(), param, DOY[0], Ta, location)
        else:
            Tg, Tm, Rn, Rn_past, G, cap_grid, diff_grid, \
                    a1_grid, a2_grid, a3_grid = initiate_groundScheme(lcgrid.copy(), param, DOY[0], Ta, location)        
    else :
        pass
    ...
    for i in np.arange(0, Ta.__len__()):
        ...
        Tmrt, Kdown, Kup, Ldown, Lup, Tg, ea, esky, I0, CI, shadow, firstdaytime, timestepdec, timeadd, \
                ...
                Lsouth, Lwest, Lnorth, KsideI, radIout, radDout, \
                Lside, Lsky_patch_characteristics, CI_TgG, KsideD, dRad, Kside, steradians, voxelTable, \
                    ...
                    Tgmap1, Tgmap1E, Tgmap1S, Tgmap1W, Tgmap1N, CI, diffsh, shmat, vegshmat, vbshvegshmat, 
                    anisotropic_sky, asvf, patch_option, voxelMaps, voxelTable, Ws[i], wallScheme, timeStep, steradians, walls_scheme, dirwalls_scheme,
                    groundScheme, Tg, Rn, Rn_past, G, Tm, cap_grid, diff_grid, a1_grid, a2_grid, a3_grid, shadow)
