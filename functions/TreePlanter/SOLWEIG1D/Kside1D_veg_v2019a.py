        ...
        if cyl == 1:
            ...
            for idx in range(0, 145):
                if aniAzi[idx] <= (180):
                    ...
                    diffRadE = (
                        diffRadE + diffsh[idx] * lumChi[idx] * anglIncE * phiVar[idx]
                    )  # * 0.5
                ...
                if aniAzi[idx] > (90) and aniAzi[idx] <= (270):
                    ...
                    diffRadS = (
                        diffRadS + diffsh[idx] * lumChi[idx] * anglIncS * phiVar[idx]
                    )  # * 0.5
                ...
                if aniAzi[idx] > (180) and aniAzi[idx] <= (360):
                    ...
                    diffRadW = (
                        diffRadW + diffsh[idx] * lumChi[idx] * anglIncW * phiVar[idx]
                    )  # * 0.5
                ...
                if aniAzi[idx] > (270) or aniAzi[idx] <= (90):
                    ...
                    diffRadN = (
                        diffRadN + diffsh[idx] * lumChi[idx] * anglIncN * phiVar[idx]
                    )  # * 0.5
