    ...
    for i in np.arange(patch_altitude.shape[0]):
        ...
        if cyl == 1:
            ...
            (
                ...
                skyp[i], Lsky_side[i, 2], Lsky_down[i, 2], patch_azimuth[i]
            )
            ...
            if solar_altitude > 0:
                ...
                if skyp[i]:
                    Keast_temp, Ksouth_temp, Kwest_temp, Knorth_temp = (
                        patch_radiation.cardinal_shortwave(
                            lumChi[i],
                            angle_of_incidence,
                            skyp[i],
                            steradians[i],
                ...
                Kref_veg += (
                    shaded_surface * vegp[i] * steradians[i] * angle_of_incidence
                )
