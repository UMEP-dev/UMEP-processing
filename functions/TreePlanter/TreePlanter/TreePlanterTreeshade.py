...
def tsh_gen(y, x, treerasters, treeinput):
    ...
    for i in range(y.__len__()):
        ...
        yslice1, xslice1, yslice2, xslice2 = tree_slice(
    ...
    return (
        ...
        tsh_pos_bool_pad_all_,
        compare,
    )


def tsh_gen_ts(y, x, treerasters, treeinput):
    tsh_bool_pad = np.zeros(
        (treeinput.rows, treeinput.cols, treerasters.treeshade_bool.shape[2])
    )
    ...
    for i in range(y.__len__()):
        ...
        tsh_bool_pad[yslice2, xslice2, :] += treerasters.treeshade_bool[
            yslice1, xslice1, :
        ]
        tsh_bool_pad_large[yslice2, xslice2] += (
            treerasters.treeshade_rg[yslice1, xslice1] > 0
        )
