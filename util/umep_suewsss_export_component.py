...
def create_GridLayout_dict():
    ...
    ssDict["dz_roof3"] = [0.2, 0.1, 0.1, 0.01, 0.01]  # TODO
    ...
    ssDict["sfr_wall"] = [0.3, 0.3, 0.4]  # TODO # (sum should be 1)
    ssDict["tin_wall"] = [5, 5, 5]
    ssDict["alb_wall"] = [0.5, 0.5, 0.5]  # TODO
    ssDict["emis_wall"] = [0.95, 0.95, 0.95]  # TODO
    ssDict["state_wall"] = [0.0, 0.0, 0.0]
    ...
    ssDict["wall_specular_frac"] = [0.0, 0.0, 0.0]

    ssDict["dz_wall1"] = [0.2, 0.1, 0.1, 0.01, 0.01]  # TODO
    ssDict["k_wall1"] = [1.2, 1.2, 1.2, 1.2, 1.2]  # TODO
    ssDict["cp_wall1"] = [3e6, 2e6, 2e6, 2e6, 2e6]  # TODO

    ssDict["dz_wall2"] = [0.2, 0.1, 0.1, 0.01, 0.01]  # TODO
    ssDict["k_wall2"] = [2.2, 1.2, 1.2, 1.2, 1.2]  # TODO
    ssDict["cp_wall2"] = [2e6, 3e6, 2e6, 2e6, 2e6]  # TODO

    ssDict["dz_wall3"] = [0.2, 0.1, 0.1, 0.01, 0.01]  # TODO
...
def write_GridLayout_file(ss_object, refdir, fname):
    ...
    f.write(
        "roof_albedo_dir_mult_fact(1,:) = {}\n".format(
            str(ss_object["roof_albedo_dir_mult_fact"])[1:-1]
        )
    )
    ...
    f.write(
        "wall_specular_frac(1,:) = {}\n".format(
            str(ss_object["wall_specular_frac"])[1:-1]
        )
    )
